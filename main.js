$(document).ready(function(){
	...
	var notice = null;
	//转盘初始化
	var color = ["#626262","#787878","rgba(0,0,0,0.5)","rgb(245,245,245)","white","rgb(194,12,12)"];
	var info = ["谢谢参与","  2个月","   商城优惠券"," 音乐","谢谢参与","  5元","    1个月","   商城优惠券"];
	var info1 = ['再接再厉','      云音乐会员','   50元','  大礼包','再接再厉','  现金红包','     云音乐会员','  30元']
	canvasRun();
